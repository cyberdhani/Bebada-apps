...
public class kuis_sunda_1 extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_sunda_1);

        Intent intent = getIntent();

        ejawab = (EditText)findViewById(R.id.ejawab);
        jawab1 = (Button)findViewById(R.id.btnjawabsunda1);
            ...
            case R.id.btnjawabsunda1:
                ...
                if (data.equals("")) {
                    ...
                    if(data.equals("BAJU"))
                    {
                        ...
                        playSound(0);
                        Intent intent = new Intent(getApplicationContext(), kuis_sunda_2.class);
