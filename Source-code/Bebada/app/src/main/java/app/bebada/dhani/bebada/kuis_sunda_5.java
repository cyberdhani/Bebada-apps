...
public class kuis_sunda_5 extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_sunda_5);

        Intent intent = getIntent();
        nilaipost = intent.getIntExtra("nilaidata", 0);
        ejawab = (EditText)findViewById(R.id.ejawab);
        jawab1 = (Button)findViewById(R.id.btnjawabsunda5);
            ...
            case R.id.btnjawabsunda5:
                ...
                if (data.equals("")) {
                    ...
                    if(data.equals("MOBIL"))
                    {
                        ...
                        playSound(0);
                        Intent intent = new Intent(getApplicationContext(), Hasil_kuis_sunda.class);
