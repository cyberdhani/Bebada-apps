...
public class kuis_jawa_5 extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_jawa_5);

        Intent intent = getIntent();
        nilaipost = intent.getIntExtra("nilaidata", 0);
        ejawab = (EditText)findViewById(R.id.ejawab5);
        jawab1 = (Button)findViewById(R.id.btnjawabjawa5);
            ...
            case R.id.btnjawabjawa5:
                ...
                if (data.equals("")) {
                    ...
                    if(data.equals("MOBIL"))
                    {
                        ...
                        playSound(0);
                        Intent intent = new Intent(getApplicationContext(), Hasil_kuis_jawa.class);
