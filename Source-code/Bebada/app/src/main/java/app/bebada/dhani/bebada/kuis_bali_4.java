...
public class kuis_bali_4 extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_bali_4);
        ...
        jawab1 = (Button)findViewById(R.id.btnjawabbali4);
            ...
            case R.id.btnjawabbali4:
                ...
                if (data.equals("")) {
                    ...
                    if(data.equals("INUM"))
                    {
                        ...
                        playSound(0);
                        Intent intent = new Intent(getApplicationContext(), kuis_bali_5.class);
