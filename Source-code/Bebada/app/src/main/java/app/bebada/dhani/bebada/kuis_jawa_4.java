...
public class kuis_jawa_4 extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_jawa_4);
        ...
        ejawab = (EditText)findViewById(R.id.ejawab4);
        jawab1 = (Button)findViewById(R.id.btnjawabjawa4);
