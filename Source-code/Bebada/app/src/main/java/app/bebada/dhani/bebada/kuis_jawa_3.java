...
public class kuis_jawa_3 extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_jawa_3);
        ...
        ejawab = (EditText)findViewById(R.id.ejawab3);
        jawab1 = (Button)findViewById(R.id.btnjawabjawa3);
            ...
            case R.id.btnjawabjawa3:
                ...
                if (data.equals("")) {
                    ...
                    if(data.equals("SEGO"))
                    {
                        ...
                        playSound(0);
                        Intent intent = new Intent(getApplicationContext(), kuis_jawa_4.class);
